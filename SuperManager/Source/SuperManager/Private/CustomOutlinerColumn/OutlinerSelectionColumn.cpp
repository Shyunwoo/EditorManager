...
const TSharedRef<SWidget> FOutlinerSelectionLockColumn::ConstructRowWidget(FSceneOutlinerTreeItemRef TreeItem, const STableRow<FSceneOutlinerTreeItemPtr>& Row)
{
    ...
    const bool bIsActorSelectionLock = SuperManagerModule.CheckIsActorSelectionLocked(ActorTreeItem->Actor.Get());
    ...
    TSharedRef <SCheckBox> ConstructedRowWidgetCheckBox = SNew(SCheckBox)
        ...
        .IsChecked(bIsActorSelectionLock ? ECheckBoxState::Checked : ECheckBoxState::Unchecked)
