...
struct FRandomActorRatation
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RandomActorRatation")
	bool bRandomizeRotYaw = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RandomActorRatation", meta = (EditCondition = "bRandomizeRotYaw"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RandomActorRatation", meta = (EditCondition = "bRandomizeRotPitch"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RandomActorRatation", meta = (EditCondition = "bRandomizeRotRoll"))
